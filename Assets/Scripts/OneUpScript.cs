...
public class OneUpScript : MonoBehaviour {
    ...
    void Update()
    {
        ...
        if (shrinking == true)
        {
            transform.localScale = new Vector3(transform.localScale.x - Time.deltaTime / 6, transform.localScale.y - Time.deltaTime / 6, transform.localScale.z - Time.deltaTime / 6);
        }
